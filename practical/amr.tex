...
\end{tcolorbox}
    ...
    We have created a fasta file containing the sequences of the genes
\texttt{fitA} and \texttt{fbpA}, take a look:
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
ariba run out ../fastq/ERR1067813\PYZus{}1.fastq.gz ../fastq/ERR1067813\PYZus{}2.fastq.gz ariba\PYZus{}results\PYZus{}ERR1067813
ariba run out ../fastq/ERR1067814\PYZus{}1.fastq.gz ../fastq/ERR1067814\PYZus{}2.fastq.gz ariba\PYZus{}results\PYZus{}ERR1067814
ariba run out ../fastq/ERR1067815\PYZus{}1.fastq.gz ../fastq/ERR1067815\PYZus{}2.fastq.gz ariba\PYZus{}results\PYZus{}ERR1067815
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
ariba summary \PYZhy{}\PYZhy{}no\PYZus{}tree all\PYZus{}samples ariba\PYZus{}results*/*.tsv
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{for} sample \PY{k}{in} \PY{l+s+sb}{`}ls ../fastq/*\PYZus{}1.fastq.gz \PY{p}{|} sed \PY{l+s+s1}{\PYZsq{}s/..\PYZbs{}/fastq\PYZbs{}///\PYZsq{}} \PY{p}{|} sed \PY{l+s+s1}{\PYZsq{}s/\PYZbs{}\PYZus{}1.fastq.gz//\PYZsq{}}\PY{l+s+sb}{`}
\PY{k}{do}
    ariba run ariba\PYZus{}card\PYZus{}db ../fastq/\PY{l+s+si}{\PYZdl{}\PYZob{}}\PY{n+nv}{sample}\PY{l+s+si}{\PYZcb{}}\PYZus{}1.fastq.gz ../fastq/\PY{l+s+si}{\PYZdl{}\PYZob{}}\PY{n+nv}{sample}\PY{l+s+si}{\PYZcb{}}\PYZus{}2.fastq.gz ariba.\PY{l+s+si}{\PYZdl{}\PYZob{}}\PY{n+nv}{sample}\PY{l+s+si}{\PYZcb{}}
\PY{k}{done}
\end{Verbatim}
\end{tcolorbox}
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{for} x \PY{k}{in} folP gyrA mtrR parC parE penA ponA porB1b rpoB rpsJ
\PY{k}{do}
