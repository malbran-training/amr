...
This tutorial uses the \texttt{ARIBA} software application. It has
already been installed on the computer you are using for this training
course. To activate the ARIBA conda environment and check that the
software is installed correctly, run the following command:
